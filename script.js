const locations = [
    ...
    "Тамада", "Құдалық", "Бешбармақ", "Шай ішу", "Той", "Беташар", "Қалжа", 
    "Диплом қорғау", "Общага", "Түнгі студия", "TikTok Хаус", 
    "Wildberries", "AirPods", "Tesla", "Донер", "Ангар", "Бизнес бастау",
    "Хайп", "Рилс", "Сторис", "Лайк", "Подписчик", "Краш", "Челлендж",
    "Флекс", "Туса", "Кринж", "Имба", "Топчик", "Жиза",
    ...
    "Стадион", "Кинотеатр", "Қонақ үй", "Пляж", "Таулар", "Дала", "Ауыл",
    "Ферма", "Зауыт", "Офис", "Студия", "Склад"
];
